...
.method private sendDeviceConnectionIntent(IILjava/lang/String;Ljava/lang/String;)V
    ...
    iget-object v2, v0, Lcom/android/server/audio/AudioService;->mNubiaVolume:Lcn/nubia/server/media/NubiaVolume;
    ...
    iget v0, v2, Landroid/media/AudioRoutesInfo;->mainType:I
    ...
    iput v0, v2, Landroid/media/AudioRoutesInfo;->mainType:I
    ...
    invoke-direct {v0, v13, v1}, Lcom/android/server/audio/AudioService;->configureHdmiPlugIntent(Landroid/content/Intent;I)V
    ...
    .line 5104
    .restart local v10    # "dev":I
    .restart local v11    # "devices":I
    .restart local v12    # "i":I
    .restart local v17    # "wiredDevices":I
    :cond_a
    add-int/lit8 v12, v12, 0x1
    ...
    :try_start_4
    invoke-static {v13, v2, v3}, Landroid/app/ActivityManagerNative;->broadcastStickyIntent(Landroid/content/Intent;Ljava/lang/String;I)V
    :try_end_4
