...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    .line 156
    new-instance v0, Lcom/android/server/AlarmManagerService$FreezeChangeReceiver;

    invoke-direct {v0, p0}, Lcom/android/server/AlarmManagerService$FreezeChangeReceiver;-><init>(Lcom/android/server/AlarmManagerService;)V

    iput-object v0, p0, Lcom/android/server/AlarmManagerService;->mFreezeChangeReceiver:Lcom/android/server/AlarmManagerService$FreezeChangeReceiver;
    ...
    iput-object v0, p0, Lcom/android/server/AlarmManagerService;->mPendingFreezeAlarms:Ljava/util/ArrayList;
...
.method static synthetic access$1200(Lcom/android/server/AlarmManagerService;Ljava/lang/String;I)V
    .locals 0
    .param p0, "x0"    # Lcom/android/server/AlarmManagerService;
...
.method deliverAlarmsLocked(Ljava/util/ArrayList;J)V
    ...
    iget-object v5, v0, Lcom/android/server/AlarmManagerService;->mPendingFreezeAlarms:Ljava/util/ArrayList;
    ...
    .line 2413
    .local v21, "isPendingFreezeAlarms":Z
    :goto_0
    const/16 v20, 0x0
    ...
    :cond_0
    iget v5, v14, Lcom/android/server/AlarmManagerService$Alarm;->uid:I
    ...
    .line 2423
    .local v23, "s1":Ljava/lang/String;
    const/16 v22, 0x0
    ...
    .line 2426
    .local v24, "s2":Ljava/lang/String;
    ...
    .line 2428
    iget v5, v14, Lcom/android/server/AlarmManagerService$Alarm;->count:I

    add-int/lit8 v5, v5, 0x1

    iput v5, v14, Lcom/android/server/AlarmManagerService$Alarm;->count:I

    .line 2433
    .end local v13    # "a":Lcom/android/server/AlarmManagerService$Alarm;
    .end local v22    # "j":I
    .end local v23    # "s1":Ljava/lang/String;
    .end local v24    # "s2":Ljava/lang/String;
    :cond_1
    if-nez v17, :cond_2
    ...
    const-string v7, "deliverAlarmsLocked don\'t deliver it uid,pid:"
    ...
    iget v7, v14, Lcom/android/server/AlarmManagerService$Alarm;->pid:I
    ...
    .end local v20    # "i":I
    .end local v21    # "isPendingFreezeAlarms":Z
    :cond_4
    const/16 v21, 0x0
    ...
    .line 2423
    .restart local v13    # "a":Lcom/android/server/AlarmManagerService$Alarm;
    .restart local v14    # "alarm":Lcom/android/server/AlarmManagerService$Alarm;
    .restart local v17    # "duplicate":Z
    .restart local v20    # "i":I
    .restart local v21    # "isPendingFreezeAlarms":Z
    .restart local v22    # "j":I
    .restart local v23    # "s1":Ljava/lang/String;
    .restart local v24    # "s2":Ljava/lang/String;
    :cond_5
...
.method updateFreezeAlarmListLocked([I[I)V
    ...
    .line 2015
    .local v5, "unknownList":Ljava/util/ArrayList;, "Ljava/util/ArrayList<Lcom/android/server/AlarmManagerService$Alarm;>;"
    iget-object v6, p0, Lcom/android/server/AlarmManagerService;->mPendingFreezeAlarms:Ljava/util/ArrayList;
    ...
    invoke-virtual {p0, p1, v6}, Lcom/android/server/AlarmManagerService;->contains([II)Z
    ...
    invoke-virtual {p0, p2, v6}, Lcom/android/server/AlarmManagerService;->contains([II)Z
    ...
    invoke-static {v6}, Lnubia/os/ApplicationManager$Trigger;->isProcessFrozenByUid(I)Z
    ...
    .line 2031
    .local v2, "nowELAPSED":J
    invoke-virtual {p0, v4, v2, v3}, Lcom/android/server/AlarmManagerService;->deliverAlarmsLocked(Ljava/util/ArrayList;J)V
    ...
    .end local v5    # "unknownList":Ljava/util/ArrayList;, "Ljava/util/ArrayList<Lcom/android/server/AlarmManagerService$Alarm;>;"
    :cond_4
    return-void
.end method
