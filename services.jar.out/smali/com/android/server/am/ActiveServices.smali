...
.method private allowStartFrozenServicePackage(Lcom/android/server/am/ProcessRecord;Lcom/android/server/am/ServiceRecord;)Z
    ...
    const-string v2, "[Frozen]allowStartFrozenServicePackage(), target_pkg = "
    ...
    const-string v2, ", target_process = "

    invoke-virtual {v1, v2}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v1

    iget-object v2, p2, Lcom/android/server/am/ServiceRecord;->processName:Ljava/lang/String;
    ...
    const-string v2, "[Frozen]start service caller PID ="
...
.method bindServiceLocked(Landroid/app/IApplicationThread;Landroid/os/IBinder;Landroid/content/Intent;Ljava/lang/String;Landroid/app/IServiceConnection;ILjava/lang/String;I)I
    ...
    .line 862
    .local v25, "serviceAction":Ljava/lang/String;
    if-eqz v25, :cond_4
    ...
    .line 870
    .end local v25    # "serviceAction":Ljava/lang/String;
    :goto_2
    ...
    .restart local v25    # "serviceAction":Ljava/lang/String;
    :cond_4
    const/16 v19, 0x0
    ...
    invoke-direct {v0, v1}, Lcom/android/server/am/ActiveServices;->isServicePackageFrozen(Lcom/android/server/am/ServiceRecord;)Z
    ...
    invoke-direct {v0, v13, v1}, Lcom/android/server/am/ActiveServices;->allowStartFrozenServicePackage(Lcom/android/server/am/ProcessRecord;Lcom/android/server/am/ServiceRecord;)Z
    ...
    const-string v6, "[FROZEN] prevent starting frozen service, pkg = "
    ...
    invoke-virtual {v4, v0}, Lcom/android/server/am/NubiaSelfStartUtil;->isInJobSchedulerList(Lcom/android/server/am/ServiceRecord;)Z
    ...
    invoke-virtual {v4, v0}, Lcom/android/server/am/NubiaSelfStartUtil;->isInSyncManagerList(Lcom/android/server/am/ServiceRecord;)Z
    ...
    invoke-virtual {v4, v0}, Lcom/android/server/am/NubiaSelfStartUtil;->isAllowedSelfStartFromBindService(Lcom/android/server/am/ServiceRecord;)Z
...
.method startServiceLocked(Landroid/app/IApplicationThread;Landroid/content/Intent;Ljava/lang/String;IILjava/lang/String;I)Landroid/content/ComponentName;
    ...
    .line 367
    .local v19, "callerProcessRecord":Lcom/android/server/am/ProcessRecord;
    if-eqz p1, :cond_2
    ...
    invoke-direct {v0, v14}, Lcom/android/server/am/ActiveServices;->isServicePackageFrozen(Lcom/android/server/am/ServiceRecord;)Z
    ...
    invoke-direct {v0, v1, v14}, Lcom/android/server/am/ActiveServices;->allowStartFrozenServicePackage(Lcom/android/server/am/ProcessRecord;Lcom/android/server/am/ServiceRecord;)Z
    ...
    invoke-static {v2, v3, v4, v5}, Lnubia/os/ApplicationManager$Trigger;->setNetworkFirewall(ILjava/lang/String;ZZ)V
    ...
    invoke-virtual {v2}, Landroid/os/Bundle;->isParcelled()Z
    ...
    .line 477
    .end local v20    # "hasExtraAlarm":Z
    .end local v21    # "isAllowStart":Z
    :cond_10
    move-object/from16 v0, p0
    ...
    .end local v22    # "proc":Lcom/android/server/am/ProcessRecord;
    .restart local v20    # "hasExtraAlarm":Z
    .restart local v21    # "isAllowStart":Z
    :catch_0
    move-exception v2
