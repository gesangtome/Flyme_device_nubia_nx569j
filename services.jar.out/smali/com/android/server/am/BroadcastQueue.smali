...
.method private allowStartFrozenReceiverPackage(Lcom/android/server/am/BroadcastRecord;Landroid/content/pm/ResolveInfo;)Z
    ...
    const-string v1, "[Frozen]allowStartFrozenReceiverPackage() 02"
...
.method private allowStartFrozenReceiverPackage(Lcom/android/server/am/BroadcastRecord;Lcom/android/server/am/BroadcastFilter;)Z
    ...
    const-string v1, "[Frozen]allowStartFrozenReceiverPackage() 01"
...
.method private deliverToRegisteredReceiverLocked(Lcom/android/server/am/BroadcastRecord;Lcom/android/server/am/BroadcastFilter;Z)V
    ...
    invoke-direct {v0, v1}, Lcom/android/server/am/BroadcastQueue;->isReceiverPackageFrozen(Lcom/android/server/am/BroadcastFilter;)Z
...
.method private isReceiverPackageFrozen(Landroid/content/pm/ResolveInfo;Lcom/android/server/am/ProcessRecord;)Z
    ...
    invoke-virtual {v3, v1, v4, v2}, Lcom/android/server/am/ActivityManagerService;->getProcessRecordLocked(Ljava/lang/String;IZ)Lcom/android/server/am/ProcessRecord;
...
.method private isReceiverPackageFrozen(Lcom/android/server/am/BroadcastFilter;)Z
    ...
    iget v0, v2, Lcom/android/server/am/ReceiverList;->pid:I
...
.method final processNextBroadcast(Z)V
    ...
    .line 1033
    .local v38, "processRecord":Lcom/android/server/am/ProcessRecord;
    move-object/from16 v0, p0
    ...
    invoke-direct {v0, v1, v2}, Lcom/android/server/am/BroadcastQueue;->isReceiverPackageFrozen(Landroid/content/pm/ResolveInfo;Lcom/android/server/am/ProcessRecord;)Z
    ...
    invoke-direct {v0, v1, v2}, Lcom/android/server/am/BroadcastQueue;->allowStartFrozenReceiverPackage(Lcom/android/server/am/BroadcastRecord;Landroid/content/pm/ResolveInfo;)Z
    ...
    .end local v38    # "processRecord":Lcom/android/server/am/ProcessRecord;
    :cond_20
    const-string v4, "BroadcastQueue"
    ...
    .restart local v22    # "i":I
    .restart local v38    # "processRecord":Lcom/android/server/am/ProcessRecord;
    ...
    const-string v7, "Broadcast caller Pid = "
    ...
    const-string v7, ", callerApp.pkgList ="
    ...
    invoke-virtual {v0, v4}, Lcom/android/server/am/NubiaSelfStartUtil;->isInCallerList(Landroid/util/ArrayMap;)Z
