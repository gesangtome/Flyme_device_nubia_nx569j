...
.method public notifyDataConnectionFailedForSubscriber(ILjava/lang/String;Ljava/lang/String;)V
    ...
    .line 1197
    .local v4, "newPreciseDataConnectionState":Landroid/telephony/PreciseDataConnectionState;
    move-object/from16 v0, p0
    ...
    invoke-virtual {v0, v5}, Lcom/android/server/TelephonyRegistry$Record;->matchPhoneStateListenerEvent(I)Z
    ...
    invoke-virtual {v0, v5, v1, v6}, Lcom/android/server/TelephonyRegistry;->idMatch(III)Z
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
    ...
    iget-object v5, v0, Lcom/android/server/TelephonyRegistry$Record;->callback:Lcom/android/internal/telephony/IPhoneStateListener;

    invoke-interface {v5, v4}, Lcom/android/internal/telephony/IPhoneStateListener;->onPreciseDataConnectionStateChanged(Landroid/telephony/PreciseDataConnectionState;)V
    :try_end_1
    .catch Landroid/os/RemoteException; {:try_start_1 .. :try_end_1} :catch_0
    .catchall {:try_start_1 .. :try_end_1} :catchall_0
    ...
    .line 1222
    .end local v4    # "newPreciseDataConnectionState":Landroid/telephony/PreciseDataConnectionState;
    ...
    .line 1217
    .restart local v4    # "newPreciseDataConnectionState":Landroid/telephony/PreciseDataConnectionState;
...
.method public notifyDataConnectionForSubscriber(IIZLjava/lang/String;Ljava/lang/String;Ljava/lang/String;Landroid/net/LinkProperties;Landroid/net/NetworkCapabilities;IZ)V
    ...
    .line 1141
    .local v3, "newPreciseDataConnectionState":Landroid/telephony/PreciseDataConnectionState;
    move-object/from16 v0, p0
    ...
    .line 1166
    .end local v3    # "newPreciseDataConnectionState":Landroid/telephony/PreciseDataConnectionState;
    .end local v15    # "i$":Ljava/util/Iterator;
    .end local v16    # "modified":Z
    :cond_9
    invoke-direct/range {p0 .. p0}, Lcom/android/server/TelephonyRegistry;->handleRemoveListLocked()V
...
.method public notifyPreciseDataConnectionFailed(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
    ...
    .prologue
    .line 1372
    const-string v1, "notifyPreciseDataConnectionFailed()"
    ...
    .line 1383
    .local v0, "newPreciseDataConnectionState":Landroid/telephony/PreciseDataConnectionState;
    ...
    invoke-virtual {v11, v1}, Lcom/android/server/TelephonyRegistry$Record;->matchPhoneStateListenerEvent(I)Z
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
    ...
    .line 1390
    :try_start_1
    iget-object v1, v11, Lcom/android/server/TelephonyRegistry$Record;->callback:Lcom/android/internal/telephony/IPhoneStateListener;

    invoke-interface {v1, v0}, Lcom/android/internal/telephony/IPhoneStateListener;->onPreciseDataConnectionStateChanged(Landroid/telephony/PreciseDataConnectionState;)V
    :try_end_1
    .catch Landroid/os/RemoteException; {:try_start_1 .. :try_end_1} :catch_0
    .catchall {:try_start_1 .. :try_end_1} :catchall_0
    ...
    .line 1403
    .end local v0    # "newPreciseDataConnectionState":Landroid/telephony/PreciseDataConnectionState;
    ...
    .line 1398
    .restart local v0    # "newPreciseDataConnectionState":Landroid/telephony/PreciseDataConnectionState;
