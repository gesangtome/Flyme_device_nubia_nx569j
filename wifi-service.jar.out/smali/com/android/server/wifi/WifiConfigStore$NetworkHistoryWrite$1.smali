.class Lcom/android/server/wifi/WifiConfigStore$NetworkHistoryWrite$1;
...
.annotation system Ldalvik/annotation/EnclosingMethod;
    value = Lcom/android/server/wifi/WifiConfigStore$NetworkHistoryWrite;->doInBackground([Ljava/lang/Void;)Ljava/lang/Void;
.end annotation
...
# instance fields
.field final synthetic this$1:Lcom/android/server/wifi/WifiConfigStore$NetworkHistoryWrite;


# direct methods
.method constructor <init>(Lcom/android/server/wifi/WifiConfigStore$NetworkHistoryWrite;)V
    .locals 0

    .prologue
    .line 2362
    iput-object p1, p0, Lcom/android/server/wifi/WifiConfigStore$NetworkHistoryWrite$1;->this$1:Lcom/android/server/wifi/WifiConfigStore$NetworkHistoryWrite;
...
.method public onWriteCalled(Ljava/io/DataOutputStream;)V
    ...
    iget-object v14, v0, Lcom/android/server/wifi/WifiConfigStore$NetworkHistoryWrite$1;->this$1:Lcom/android/server/wifi/WifiConfigStore$NetworkHistoryWrite;

    # getter for: Lcom/android/server/wifi/WifiConfigStore$NetworkHistoryWrite;->mNetworks:Ljava/util/List;
    invoke-static {v14}, Lcom/android/server/wifi/WifiConfigStore$NetworkHistoryWrite;->access$400(Lcom/android/server/wifi/WifiConfigStore$NetworkHistoryWrite;)Ljava/util/List;
    ...
    iget-object v14, v14, Lcom/android/server/wifi/WifiConfigStore$NetworkHistoryWrite;->this$0:Lcom/android/server/wifi/WifiConfigStore;
    ...
    invoke-static {v14, v15}, Lcom/android/server/wifi/WifiConfigStore;->access$500(Ljava/util/BitSet;[Ljava/lang/String;)Ljava/lang/String;
    ...
    # getter for: Lcom/android/server/wifi/WifiConfigStore$NetworkHistoryWrite;->mDeletedSSIDs:Ljava/util/List;
    invoke-static {v14}, Lcom/android/server/wifi/WifiConfigStore$NetworkHistoryWrite;->access$600(Lcom/android/server/wifi/WifiConfigStore$NetworkHistoryWrite;)Ljava/util/List;
    ...
    # getter for: Lcom/android/server/wifi/WifiConfigStore$NetworkHistoryWrite;->mDeletedEphemeralSSIDs:Ljava/util/List;
    invoke-static {v14}, Lcom/android/server/wifi/WifiConfigStore$NetworkHistoryWrite;->access$700(Lcom/android/server/wifi/WifiConfigStore$NetworkHistoryWrite;)Ljava/util/List;
