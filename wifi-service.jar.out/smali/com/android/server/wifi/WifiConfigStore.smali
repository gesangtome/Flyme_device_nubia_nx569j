...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        ...
        Lcom/android/server/wifi/WifiConfigStore$NetworkHistoryWrite;,
...
.field private static final ASYNC_WRITE_NETWORK_HISTORYFILE:Z = true
...
.method static synthetic access$300()Ljava/lang/String;
    ...
    .prologue
    .line 162
    sget-object v0, Lcom/android/server/wifi/WifiConfigStore;->networkHistoryConfigFile:Ljava/lang/String;

    return-object v0
.end method

.method static synthetic access$500(Ljava/util/BitSet;[Ljava/lang/String;)Ljava/lang/String;
    .locals 1
...
.method static synthetic access$800(Lcom/android/server/wifi/WifiConfigStore;)Lcom/android/server/net/DelayedDiskWrite;
    .locals 1
    .param p0, "x0"    # Lcom/android/server/wifi/WifiConfigStore;
...
.method private addOrUpdateNetworkNative(Landroid/net/wifi/WifiConfiguration;I)Lcom/android/server/wifi/NetworkUpdateResult;
    ...
    const-string v6, "allowedProtocolsString["
    ...
    const-string v6, "]config.allowedProtocols["
    ...
    const-string v6, "savedConfig.allowedProtocols:"
    ...
    const-string v6, "config.allowedProtocols.cardinality:"
...
.method enableVerboseLogging(I)V
    ...
    .line 707
    invoke-static {p1}, Lcom/android/server/wifi/ScanDetailCache;->enableVerboseLogging(I)V
...
.method getRecentConfiguredNetworks(IZ)Ljava/util/List;
    ...
    const-string v5, ": bypass due to autoJoinStatus= "
    ...
    const-string v5, ": bypass due to cache is null !"
    ...
    const-string v5, ": bypass due to visibility is null !"
    ...
    const-string v5, ": bypass due to rssi is INVALID! "
...
.method public getScanDetailCache(Landroid/net/wifi/WifiConfiguration;)Lcom/android/server/wifi/ScanDetailCache;
    ...
    invoke-virtual {v0}, Lcom/android/server/wifi/ScanDetailCache;->isEmpty()Z
...
.method loadConfiguredNetworks()V
    ...
    .line 1847
    .local v7, "configTlsResetList":Ljava/util/List;, "Ljava/util/List<Landroid/net/wifi/WifiConfiguration;>;"
    const/4 v15, -0x1
    ...
    invoke-direct {v0, v6}, Lcom/android/server/wifi/WifiConfigStore;->readNetworkVariables(Landroid/net/wifi/WifiConfiguration;)V
    ...
    .line 1890
    .local v8, "csum":Ljava/util/zip/Checksum;
    ...
    invoke-interface {v8, v0, v1, v2}, Ljava/util/zip/Checksum;->update([BII)V
    ...
    invoke-virtual {v6, v0}, Landroid/net/wifi/WifiConfiguration;->setIpAssignment(Landroid/net/IpConfiguration$IpAssignment;)V
    ...
    invoke-virtual {v6, v0}, Landroid/net/wifi/WifiConfiguration;->setProxySettings(Landroid/net/IpConfiguration$ProxySettings;)V
    ...
    .line 1910
    .local v21, "tempCfg":Landroid/net/wifi/WifiConfiguration;
    if-eqz v21, :cond_7
    ...
    invoke-virtual {v0, v1, v6}, Lcom/android/server/wifi/ConfigurationMap;->put(ILandroid/net/wifi/WifiConfiguration;)Landroid/net/wifi/WifiConfiguration;

    .line 1917
    new-instance v5, Lcom/android/server/wifi/ScanDetailCache;

    invoke-direct {v5, v6}, Lcom/android/server/wifi/ScanDetailCache;-><init>(Landroid/net/wifi/WifiConfiguration;)V

    .line 1918
    .local v5, "cache":Lcom/android/server/wifi/ScanDetailCache;
    move-object/from16 v0, p0
    ...
    invoke-virtual {v6, v0}, Landroid/net/wifi/WifiConfiguration;->setAutoJoinStatus(I)V

    .line 1935
    .end local v5    # "cache":Lcom/android/server/wifi/ScanDetailCache;
    .end local v21    # "tempCfg":Landroid/net/wifi/WifiConfiguration;
    :cond_7
    :goto_4
    if-eqz v6, :cond_8
    ...
    .line 1865
    .end local v8    # "csum":Ljava/util/zip/Checksum;
    :cond_8
    :goto_5
    ...
    .line 1923
    .restart local v8    # "csum":Ljava/util/zip/Checksum;
    :cond_c
    invoke-static {v6}, Lcom/android/server/wifi/WifiServiceImpl;->isValid(Landroid/net/wifi/WifiConfiguration;)Z
    ...
    .line 1927
    .restart local v5    # "cache":Lcom/android/server/wifi/ScanDetailCache;
    move-object/from16 v0, p0
    ...
    invoke-virtual {v0, v6, v1}, Lcom/android/server/wifi/WifiConfigStore;->addOrUpdateNetwork(Landroid/net/wifi/WifiConfiguration;I)I
...
.method public writeKnownNetworkHistory(Z)V
    ...
    invoke-virtual {v9}, Lcom/android/server/wifi/ConfigurationMap;->values()Ljava/util/Collection;
    ...
    invoke-direct {v9, v0}, Landroid/net/wifi/WifiConfiguration;-><init>(Landroid/net/wifi/WifiConfiguration;)V

    invoke-interface {v7, v9}, Ljava/util/List;->add(Ljava/lang/Object;)Z

    .line 2136
    iget-boolean v9, v0, Landroid/net/wifi/WifiConfiguration;->dirty:Z
    ...
    const-string v10, " rewrite network history for "
    ...
    .line 2138
    iput-boolean v12, v0, Landroid/net/wifi/WifiConfiguration;->dirty:Z
    ...
    iget-object v9, p0, Lcom/android/server/wifi/WifiConfigStore;->mDeletedSSIDs:Ljava/util/Set;
    ...
    const-string v10, " writeKnownNetworkHistory() num networks:"
    ...
    .line 2160
    :cond_5
    new-instance v6, Lcom/android/server/wifi/WifiConfigStore$NetworkHistoryWrite;

    invoke-direct {v6, p0, v7, v3, v2}, Lcom/android/server/wifi/WifiConfigStore$NetworkHistoryWrite;-><init>(Lcom/android/server/wifi/WifiConfigStore;Ljava/util/List;Ljava/util/List;Ljava/util/List;)V

    .line 2161
    .local v6, "networkHistoryWrite":Lcom/android/server/wifi/WifiConfigStore$NetworkHistoryWrite;
    new-array v9, v12, [Ljava/lang/Void;

    invoke-virtual {v6, v9}, Lcom/android/server/wifi/WifiConfigStore$NetworkHistoryWrite;->execute([Ljava/lang/Object;)Landroid/os/AsyncTask;
