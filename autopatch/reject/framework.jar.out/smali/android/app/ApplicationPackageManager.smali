...
.method private getVirtualBoxDrawable(Landroid/os/UserHandle;)Landroid/graphics/drawable/Drawable;
    ...
    invoke-direct {p0, v4}, Landroid/app/ApplicationPackageManager;->getUserIfProfile(I)Landroid/content/pm/UserInfo;
    ...
    invoke-interface {v4, v5}, Lcom/cmx/cmplus/ISmartContainerManager;->getContainerInfo(I)Lcom/cmx/cmplus/ContainerInfo;
    ...
    invoke-static {v4}, Lnubia/util/NubiaCloneHelper;->getCloneBadgedDrawable(Landroid/content/Context;)Landroid/graphics/drawable/Drawable;
    :try_end_0
...
.method public getUserBadgeForDensity(Landroid/os/UserHandle;I)Landroid/graphics/drawable/Drawable;
    ...
    const v3, #android:drawable@ic_corp_badge#t
...
.method public getUserBadgedIcon(Landroid/graphics/drawable/Drawable;Landroid/os/UserHandle;)Landroid/graphics/drawable/Drawable;
    ...
    .line 996
    .local v3, "badgedWidth":I
    invoke-virtual {p1}, Landroid/graphics/drawable/Drawable;->getIntrinsicHeight()I

    move-result v2

    .line 998
    .local v2, "badgedHeight":I
    if-eqz v0, :cond_1

    .line 999
    invoke-direct {p0, p1, v0, v5, v6}, Landroid/app/ApplicationPackageManager;->getBadgedDrawable(Landroid/graphics/drawable/Drawable;Landroid/graphics/drawable/Drawable;Landroid/graphics/Rect;Z)Landroid/graphics/drawable/Drawable;

    move-result-object p1

    .line 1008
    .end local v0    # "badgeIcon":Landroid/graphics/drawable/Drawable;
    .end local v2    # "badgedHeight":I
    .end local v3    # "badgedWidth":I
    ...
    invoke-direct {p0, v4}, Landroid/app/ApplicationPackageManager;->getBadgeResIdForUser(I)I
    ...
    invoke-virtual {p0, v4, v1, v5}, Landroid/app/ApplicationPackageManager;->getDrawable(Ljava/lang/String;ILandroid/content/pm/ApplicationInfo;)Landroid/graphics/drawable/Drawable;
...
.method public getUserBadgedLabel(Ljava/lang/CharSequence;Landroid/os/UserHandle;)Ljava/lang/CharSequence;
    ...
    const v3, #android:string@clone_label_badge#t
