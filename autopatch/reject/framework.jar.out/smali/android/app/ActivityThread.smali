...
.field public static isSystemServer:Z
...
.method static constructor <clinit>()V
    ...
    sput-boolean v0, Landroid/app/ActivityThread;->isSystemServer:Z
...
<<<<<<< VENDOR #Conflict 1
    invoke-direct {v0, p0, v2}, Landroid/app/ActivityThread$ApplicationThread;-><init>(Landroid/app/ActivityThread;Landroid/app/ActivityThread$1;)V
...
>>>>>>> BOSP #Conflict 1
    ...
    invoke-direct {v0, p0, v2}, Landroid/app/ActivityThread$H;-><init>(Landroid/app/ActivityThread;Landroid/app/ActivityThread$1;)V
    ...
    iput-object v2, p0, Landroid/app/ActivityThread;->mLongSnapJobMgr:Landroid/app/LongSnapClientJobManager;

    iput-boolean v1, p0, Landroid/app/ActivityThread;->mLongSnapReceiverRegistered:Z

    const/4 v0, 0x6

    iput v0, p0, Landroid/app/ActivityThread;->MAX_SNAP_PAGE_CNT:I
...
.method static synthetic access$3400(Landroid/app/ActivityThread;)Landroid/app/Activity;
    .locals 1
    .param p0, "x0"    # Landroid/app/ActivityThread;
...
.method static synthetic access$3500(Landroid/app/ActivityThread;)Landroid/app/LongSnapClientJobManager;
    .locals 1
    .param p0, "x0"    # Landroid/app/ActivityThread;
...
.method private findResumedActivity()Landroid/app/Activity;
    ...
    iget-object v1, v3, Landroid/app/ActivityThread$ActivityClientRecord;->activity:Landroid/app/Activity;

    .line 2442
    .local v1, "a":Landroid/app/Activity;
    iget-boolean v5, v1, Landroid/app/Activity;->mResumed:Z
...
.method private handleBindApplication(Landroid/app/ActivityThread$AppBindData;)V
    ...
    iput-wide v4, v0, Landroid/app/ActivityThread;->processTypefaceTimeStamp:J
    ...
    const-string/jumbo v2, "sotertest.soter.mm.tencent.com.sotertest"
...
<<<<<<< VENDOR #Conflict 2
    iget-object v1, p0, Landroid/app/ActivityThread;->mActivities:Landroid/util/ArrayMap;
======= #@.method private handlePauseActivity@
...
.method private performLaunchActivity(Landroid/app/ActivityThread$ActivityClientRecord;Landroid/content/Intent;)Landroid/app/Activity;
    ...
    iget-boolean v4, v0, Landroid/app/ActivityThread;->mLongSnapReceiverRegistered:Z
    ...
    const-string v6, "registerLongSnapReceiver for "
    ...
    invoke-virtual {v8, v4}, Landroid/app/Application;->getSystemService(Ljava/lang/String;)Ljava/lang/Object;
    ...
    .local v21, "dispHeight":I
    new-instance v4, Landroid/app/LongSnapClientJobManager;
    ...
    invoke-direct {v4, v0, v1, v5}, Landroid/app/LongSnapClientJobManager;-><init>(III)V

    move-object/from16 v0, p0

    iput-object v4, v0, Landroid/app/ActivityThread;->mLongSnapJobMgr:Landroid/app/LongSnapClientJobManager;

    move-object/from16 v0, p0

    invoke-direct {v0, v8}, Landroid/app/ActivityThread;->registerLongSnapReceiver(Landroid/content/Context;)V

    const/4 v4, 0x1

    move-object/from16 v0, p0

    iput-boolean v4, v0, Landroid/app/ActivityThread;->mLongSnapReceiverRegistered:Z

    .end local v21    # "dispHeight":I
    .end local v22    # "dispWidth":I
...
.method private updateVisibility(Landroid/app/ActivityThread$ActivityClientRecord;Z)V
    ...
    invoke-static {p1}, Landroid/app/ActivityThread$ActivityClientRecord;->access$3600(Landroid/app/ActivityThread$ActivityClientRecord;)Landroid/content/res/Configuration;
...
.method final handleActivityConfigurationChanged(Landroid/app/ActivityThread$ActivityConfigChangeData;)V
    ...
    :cond_1
    # getter for: Landroid/app/ActivityThread$ActivityClientRecord;->tmpConfig:Landroid/content/res/Configuration;
    invoke-static {v0}, Landroid/app/ActivityThread$ActivityClientRecord;->access$3600(Landroid/app/ActivityThread$ActivityClientRecord;)Landroid/content/res/Configuration;
...
.method final handleConfigurationChanged(Landroid/content/res/Configuration;Landroid/content/res/CompatibilityInfo;)V
    ...
    :cond_3
    iget-wide v6, p0, Landroid/app/ActivityThread;->processTypefaceTimeStamp:J

    iget-object v4, p1, Landroid/content/res/Configuration;->extraConfig:Lnubia/content/res/ExtraConfiguration;

    iget-wide v8, v4, Lnubia/content/res/ExtraConfiguration;->typefaceTimeStamp:J
    ...
    iput-boolean v6, v4, Lnubia/content/res/ExtraConfiguration;->needReloadProcessTypeface:Z
...
.method final handleResumeActivity(Landroid/os/IBinder;ZZZ)V
    ...
    # getter for: Landroid/app/ActivityThread$ActivityClientRecord;->tmpConfig:Landroid/content/res/Configuration;
    invoke-static {v4}, Landroid/app/ActivityThread$ActivityClientRecord;->access$3600(Landroid/app/ActivityThread$ActivityClientRecord;)Landroid/content/res/Configuration;
