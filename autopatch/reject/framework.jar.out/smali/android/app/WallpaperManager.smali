...
.method public saveGalleryBitmapFile(Ljava/io/File;)V
    .locals 4
    ...
    const-string v3, "cn.nubia.gallerylockscreen"
    ...
    const-string v3, "saveGalleryBitmapFile : WallpaperService not running"
    ...
    .local v1, "fd1":Landroid/os/ParcelFileDescriptor;
    sget-object v2, Landroid/app/WallpaperManager;->sGlobals:Landroid/app/WallpaperManager$Globals;
    ...
    invoke-interface {v2, v1}, Landroid/app/IWallpaperManager;->setGalleryFile(Landroid/os/ParcelFileDescriptor;)V
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0

    goto :goto_0

    .end local v1    # "fd1":Landroid/os/ParcelFileDescriptor;
    :catch_0
    move-exception v0
    ...
    const-string v3, "saveGalleryBitmapFile : can not get WallpaperManagerService remote function"
...
.method public setWallpaperComponent(Landroid/content/ComponentName;Z)Z
    ...
    invoke-interface {v1, p1, p2}, Landroid/app/IWallpaperManager;->setWallpaperComponentNotify(Landroid/content/ComponentName;Z)V
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
