...
.field static final ID_SELECT:I = 0x30d0082
...
.method private doKeyDown(ILandroid/view/KeyEvent;Landroid/view/KeyEvent;)I
    ...
    invoke-interface {v7, p0, v3, p3}, Landroid/text/method/MovementMethod;->onKeyOther(Landroid/widget/TextView;Landroid/text/Spannable;Landroid/view/KeyEvent;)Z
    :try_end_1
    ...
    invoke-interface {v7, p0, v3, p1, p2}, Landroid/text/method/MovementMethod;->onKeyDown(Landroid/widget/TextView;Landroid/text/Spannable;ILandroid/view/KeyEvent;)Z
...
>>>>>>> BOSP #Conflict 3
    ...
    iget-boolean v7, v7, Landroid/widget/Editor;->mSelectionControllerEnabled:Z

    if-eqz v7, :cond_1

    iget-object v7, p0, Landroid/widget/TextView;->mEditor:Landroid/widget/Editor;

    invoke-virtual {v7}, Landroid/widget/Editor;->startTextSelectionMode()Z
    ...
    invoke-virtual {v7}, Landroid/widget/Editor;->undo()V
    ...
    invoke-virtual {v7}, Landroid/widget/Editor;->redo()V
    ...
    invoke-static {v8, v7}, Landroid/content/ClipData;->newPlainText(Ljava/lang/CharSequence;Ljava/lang/CharSequence;)Landroid/content/ClipData;

    move-result-object v7

    invoke-direct {p0, v7}, Landroid/widget/TextView;->setPrimaryClip(Landroid/content/ClipData;)V
    ...
    invoke-virtual {v7}, Landroid/widget/Editor;->replace()V
    ...
    invoke-virtual {v0, v7, v5}, Landroid/view/inputmethod/InputMethodManager;->hideSoftInputFromWindow(Landroid/os/IBinder;I)Z
    ...
    .sparse-switch
        ...
        #android:id@cut#t -> :sswitch_6
        #android:id@copy#t -> :sswitch_7
        #android:id@paste#t -> :sswitch_4
        #android:id@pasteAsPlainText#t -> :sswitch_5
        #android:id@undo#t -> :sswitch_2
        #android:id@redo#t -> :sswitch_3
        #android:id@replaceText#t -> :sswitch_8
        #android:id@shareText#t -> :sswitch_9
        0x30d0082 -> :sswitch_1
    .end sparse-switch
.end method
