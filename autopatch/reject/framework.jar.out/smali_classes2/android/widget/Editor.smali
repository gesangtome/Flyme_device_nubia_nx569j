...
.field private static final MENU_ITEM_ORDER_COPY:I = 0x1

.field private static final MENU_ITEM_ORDER_CUT:I = 0x2
...
.method static synthetic access$3300(Landroid/widget/Editor;Landroid/view/MotionEvent;)V
    .locals 0
    .param p0, "x0"    # Landroid/widget/Editor;
...
.method static synthetic access$3400(Landroid/widget/Editor;)Ljava/lang/Runnable;
    .locals 1
    .param p0, "x0"    # Landroid/widget/Editor;
...
.method static synthetic access$3402(Landroid/widget/Editor;Ljava/lang/Runnable;)Ljava/lang/Runnable;
    .locals 0
    .param p0, "x0"    # Landroid/widget/Editor;
...
.method static synthetic access$3900(Landroid/widget/Editor;IZ)I
    .locals 1
    .param p0, "x0"    # Landroid/widget/Editor;
    .param p1, "x1"    # I
    .param p2, "x2"    # Z
...
.method static synthetic access$4000(Landroid/widget/Editor;)Landroid/text/method/WordIterator;
    .locals 1
    .param p0, "x0"    # Landroid/widget/Editor;
...
.method private selectCurrentRange()Z
    .locals 15
    ...
    .line 5836
    invoke-virtual {p0}, Landroid/widget/Editor;->selectAllWrap()Z
    ...
    .line 5878
    :cond_9
    invoke-virtual {p0, v4}, Landroid/widget/Editor;->getCharRangeWrap(I)J

    move-result-wide v6

    .line 5879
    .local v6, "range":J
    invoke-static {v6, v7}, Landroid/widget/Editor;->extractRangeStartFromLong(J)I

    move-result v8

    .line 5880
    invoke-static {v6, v7}, Landroid/widget/Editor;->extractRangeEndFromLong(J)I
...
.method public performLongClickForNote(Z)Z
    .locals 10
    .param p1, "handled"    # Z
...
<<<<<<< VENDOR #Conflict 1
    ...
    :cond_4
======= #@.method prepareCursorControllers@
...
.method startTextSelectionMode()Z
    ...
    invoke-direct {p0}, Landroid/widget/Editor;->selectCurrentRange()Z
...
======= #@.method protected stopTextActionMode@
